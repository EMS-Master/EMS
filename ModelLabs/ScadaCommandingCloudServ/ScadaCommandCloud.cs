...
namespace ScadaCommandingCloudServ
{
    public class ScadaCommandCloud : IScadaCommandingContract, ITransactionContract
    {
        ...
        public bool SendDataToSimulator(List<MeasurementUnit> measurements)
        {
            ...
            //ServiceEventSource.Current.Message("SendDataToSimulator executed...\n");
            return true;
        }
        ...
        public bool CommandDiscreteValues(long gid, bool value, int scadaAddress)
        {
            ...
            ServiceEventSource.Current.Message("[CommandDiscreteValues] executed...\n");
            if(value == true)
                ServiceEventSource.Current.Message("Generator with gid [{0}] is switched on!\n", gid);
            else
                ServiceEventSource.Current.Message("Generator with gid [{0}] is switched off!\n", gid);
        ...
        public bool CommandAnalogValues(long gid, float value)
        {
            ...
            Console.WriteLine("SendDataToSimulator executed...\n");
            Console.WriteLine("[CommandAnalogValues] executed...\n");
            ServiceEventSource.Current.Message("[CommandAnalogValues] executed...\n");
            ServiceEventSource.Current.Message("Generator with gid [{0}] commanded with value: {1}", gid, value);
