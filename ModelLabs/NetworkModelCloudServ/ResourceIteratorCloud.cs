...
{
    public class ResourceIteratorCloud
    {
        private static NetworkModelCloud networkModel = null;
        ...
        {
            set { ResourceIteratorCloud.networkModel = value; }
        }

        public ResourceIteratorCloud()
        {
        }

        public ResourceIteratorCloud(List<long> globalIDs, Dictionary<DMSType, List<ModelCode>> class2PropertyIDs)
        {
        ...
        private List<ResourceDescription> CollectData(List<long> resultIDs)
        {
            ...
            catch (Exception ex)
            {
                ...
                //ServiceEventSource.Current.Message("Collecting ResourceDescriptions failed. Exception: " + ex.Message);
                throw;
            }
        }
    }
