...
namespace CostAndProfitClaculationService
{
    ...
    internal sealed class CostAndProfitClaculationService : StatelessService
    {
        ...
        protected override IEnumerable<ServiceInstanceListener> CreateServiceInstanceListeners()
        {
            ...
            {
                new ServiceInstanceListener(context => this.CreateCostAndProfitListener(context), "CostAndProfitCalculationEndpoint"),
            };
        }

        private ICommunicationListener CreateCostAndProfitListener(StatelessServiceContext context)
        {
            var listener = new WcfCommunicationListener<ICostAndProfitCalculation>(
                listenerBinding: Binding.CreateCustomNetTcp(),
                endpointResourceName: "CostAndProfitCalculationEndpoint",
                serviceContext: context,
                wcfServiceObject: costAndProfitCalculation
            );
