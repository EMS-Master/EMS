...
namespace FTN.Common.ModbusSingleInstance
{
    public class MdbClientSingleton
    {
        private static MdbClientSingleton instance = null;
        ...
        //private MdbClientSingleton(string ipAddress, int port)
        //{
        //    try
        //    {
        //        IPAddress = ipAddress;
        ...
        public static MdbClientSingleton Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new MdbClientSingleton();
                }
                return instance;
            }
        }
        ...
        private byte[] SendAndReceive(ushort startingAddress, ushort quantity, FunctionCode functionCode)
        {
            ...
            lock (client)
            {
                ...
                returnData = new byte[numberOfBytes];
